	...
	<div class="ex-reviews__carousel" id="ex-reviews-carousel<?php echo $module; ?>">
		<div class="<?php echo $settings['box_classname']; ?>">
			...
			<div class="ex-reviews__carousel-container owl-carousel owl-theme">
				<?php foreach($reviews as $_key => $review) { ?> 
				<div class="ex-reviews__carousel-item item <?php echo $settings['card_classname']; ?>">
...
<?php if ($settings['carousel_type'] == 2) { ?>
$('#ex-reviews-carousel<?php echo $module; ?> .ex-reviews__carousel-container').owlCarousel({
      	loop:true,
		margin: <?php echo (($style['box']['margin']) ? ($style['box']['margin']) : (10)); ?>,
		responsiveClass:true,
		items : <?php echo $carousel['count_1200']; ?>,
		<?php if (isset($carousel['pagination'])) { ?>
		pagination: true,
		<?php } else { ?>
		pagination: false,
		<?php } ?>
		<?php if (isset($carousel['arrows'])) { ?>
		navigation: true,
		<?php } ?>
		navigationText: ["<i class='fa fa-angle-left'></i>", "<i class='fa fa-angle-right'></i>"],
		itemsCustom : [
					[0, <?php echo $carousel['count_0']; ?>],
					[481, <?php echo $carousel['count_481']; ?>],
					[769, <?php echo $carousel['count_769']; ?>],
					[1200, <?php echo $carousel['count_1200']; ?>],
					],
});
<?php } else { ?>
  $('#ex-reviews-carousel<?php echo $module; ?> .ex-reviews__carousel-container').owlCarousel({
		...
		<?php } ?>
                    responsive:{
                    0:{
                      items: <?php echo $carousel['count_0']; ?>,
                    },
                    481:{
                        items:<?php echo $carousel['count_481']; ?>,
                    },
                    769:{
                        items:<?php echo $carousel['count_769']; ?>,
                    },
                    1200:{
                      items: <?php echo $carousel['count_1200']; ?>,
                    },
...
--></script>
<style type="text/css">
.ex-reviews__carousel .owl-wrapper, .ex-reviews__carousel .owl-stage
{
...
.ex-reviews__carousel .owl-stage-outer{
	overflow: visible;
}
.ex-reviews__carousel .owl-nav button {
	width: 20px;
    height: 20px;
}
.ex-reviews__carousel .owl-dots, .ex-reviews__carousel .owl-nav button{
	outline: 0 !important;
}
.ex-reviews__photo a{
