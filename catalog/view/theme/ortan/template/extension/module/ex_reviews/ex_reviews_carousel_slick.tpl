	...
	<div class="ex-reviews__carousel" id="ex-reviews-carousel<?php echo $module; ?>">
		<div class="<?php echo $settings['box_classname']; ?>">
			...
			<div class="ex-reviews__carousel-container">
					...
					<div class="ex-reviews__carousel-item swiper-slide <?php echo $settings['card_classname']; ?>">
							...
							<div class="review-media-container">
								...
								<div class="ex-reviews__thumbneils">
									...
									<div class="ex-reviews__video"><a
											<?php echo (($settings['gallery_type'] == 2) ? ('data-fancybox') : ('')); ?>
											class="popup-youtube"
			...
			<a href="<?php echo $all_reviews_link; ?>" type="button" class="ex-carousel-btn"><?php echo $text_all; ?><svg class="ex-arrow-right"><use href="#ex-arrow"></use></svg></a>
		</div>
	</div>
<script type="text/javascript"><!--

$('#ex-reviews-carousel<?php echo $module; ?> .ex-reviews__carousel-container').slick({
  ...
  infinite: true,
  speed: 300,
  slidesToShow: <?php echo $carousel['count_1200']; ?>,
  slidesToScroll: 2,
  responsive: [
    {
      breakpoint: 1024,
      settings: {
        slidesToShow: <?php echo $carousel['count_769']; ?>,
        slidesToScroll: <?php echo $carousel['count_769']; ?>,
      }
    },
    {
      breakpoint: 769,
      settings: {
        slidesToShow: <?php echo $carousel['count_481']; ?>,
        slidesToScroll: <?php echo $carousel['count_481']; ?>
      }
    },
    {
      breakpoint: 481,
      settings: {
        slidesToShow: <?php echo $carousel['count_0']; ?>,
        slidesToScroll: <?php echo $carousel['count_0']; ?>
      }
    }
  ]
});
