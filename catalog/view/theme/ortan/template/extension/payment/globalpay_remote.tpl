...
<div class="buttons">
  <div class="pull-right">
    <input type="button" value="<?php echo $button_confirm; ?>" id="button-confirm" data-loading-text="<?php echo $text_loading; ?>" class="btn btn_red" />
  </div>
</div>
...
$('#button-confirm').bind('click', function() {
  $.ajax({
    ...
    beforeSend: function() {
      ...
      $('#payment').before('<div id="globalpay-message-wait" class="alert alert-info"><i class="fa fa-info-circle"></i> <?php echo $text_wait; ?></div>');
    },
