...
<?php if ($summ < 15000) { ?>
    <input type="button" value="<?php echo $button_confirm; ?>" id="button-confirm" class="btn btn_red" data-loading-text="<?php echo $text_loading; ?>" />
<?php } else { ?>
    <input type="button" value="<?php echo $button_back; ?>" id="payment_back" class="btn btn_red" data-loading-text="<?php echo $text_loading; ?>" />
<?php } ?>
