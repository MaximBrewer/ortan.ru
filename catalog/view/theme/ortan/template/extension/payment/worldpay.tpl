<?php if (!empty($existing_cards)) { ?>
	...
	<form id="payment-existing-form" action="<?php echo $form_submit; ?>" method="post" class="form-horizontal">
		...
		<div id="card-existing">
		  ...
		  <div class="buttons clearfix">
			<div class="pull-right">
			  <input type="button" value="<?php echo $button_delete_card; ?>" id="button-delete" data-loading-text="<?php echo $text_loading; ?>" class="btn btn_red" />
			</div>
		  </div>
		  <div class="form-group required">
	  ...
	  <div class="buttons">
		<div class="pull-right">
		  <input type="submit" value="<?php echo $button_confirm; ?>" id="button-confirm" data-loading-text="<?php echo $text_loading; ?>" class="btn btn_red" />
		</div>
	  </div>
	</form>
