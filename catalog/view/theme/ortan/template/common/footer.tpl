    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="callBack-modal">
                ...
                <div id="popup__formWrapper"><?php include $_SERVER['DOCUMENT_ROOT'] . '/catalog/view/theme/ortan/template/information/contact_form.tpl'; ?></div>
            </div>
        </div>
    </div>
</div>
...
<footer class="footer">
    <div class="dialogBtn">
         <a target="_blank" href="<?php echo $config['config_social_telegram']; ?>" class="manager__social manager__social_tg footer__manager__social_tg">
		...
		<?php
		$off_arr = array ("(",")"," ","-");
		$whatsapp1 = str_replace($off_arr,"",$config['config_fax']);
		$whatsapp = str_replace("8","7",$whatsapp1);
		?>
        <a target="_blank" href="https://api.whatsapp.com/send?phone=<?php echo $whatsapp; ?>" class="manager__social manager__social_wp footer__manager__social_wp ">
    ...
    <div class="footer__container container">
        <ul class="footer__nav">
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>tovary/" class="footer__link">Каталог</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>novelties/" class="footer__link">Новинки</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>tovary/discounts/" class="footer__link">Скидки</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>bestseller/" class="footer__link">Бестселлеры</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>delivery/" class="footer__link">Доставка и оплата</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>otzyvy/" class="footer__link">Отзывы</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>motoekipirovka-optom/" class="footer__link">Оптовикам</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>garantii/" class="footer__link">Гарантии</a>
            </li>
            <li class="footer__item">
                <a href="https://<?= $lang_link ?>contact-us/" class="footer__link">Контакты</a>
            </li>
        </ul>
        <div class="footer__data">
            <span class="footer__fights">ORTAN © 2016-<?php echo date("Y"); ?> Все права защищены</span>
            <a href="https://<?= $lang_link ?>privacy/" class="footer__policy">Политика конфиденциальности</a>
            <div class="footer__contacts">
                <span class="footer__address"><?php echo $cityArray['city'];?>, <?php echo $cityArray['address'];?>
                    <br /><?php echo $config['config_email']; ?>
                </span>
                <div class="footer__links">
                    Принимаем&nbsp;заказы&nbsp;24/7,<br/>
                    Режим&nbsp;работы:<br/>
                    <?php echo $config['config_langdata'][1]['open'];?>
                </div>
                <div class="footer__links">
                    <a href="tel:<?php echo $config['config_telephone']; ?>" class="footer__tel"
                    ...
                    <a href="tel:<?php echo $config['config_fax']; ?>" class="footer__tel"
                       onclick="ym('53398495','reachGoal','lClickPhone'); return true;"
                       oncontextmenu="ym('53398495','reachGoal','rClickPhone'); return true;"
                       oncopy="ym(53398495,'reachGoal','copyPhone'); return true;"
            ...
            <div class="footer__socials">
                <a rel="nofollow" target="_blank" href="<?php echo $config['config_social_telegram']; ?>" class="footer__social"><img src="/catalog/view/theme/ortan/assets/images/icon-telegram-gray.svg" alt="telegram" class="footer__icon"></a>
                <a rel="nofollow" target="_blank" href="<?php echo $config['config_social_vk']; ?>" class="footer__social"><img src="/catalog/view/theme/ortan/assets/images/icon-vk-gray.svg" alt="vk" class="footer__icon"></a>
                <!--a rel="nofollow" target="_blank" href="<?php echo $config['config_social_instagram']; ?>" class="footer__social"><img src="/catalog/view/theme/ortan/assets/images/icon-instagram-gray.svg" alt="instagram" class="footer__icon"></a-->
                <a rel="nofollow" target="_blank" href="<?php echo $config['config_social_youtube']; ?>" class="footer__social"><img src="/catalog/view/theme/ortan/assets/images/icon-youtube-gray.svg" alt="youtube" class="footer__icon"></a>
            </div>
        </div>
    </div>
</footer>
