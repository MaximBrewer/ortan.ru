    ...
    <div class="productm__container container">
        ...
        <div class="productm__wrapper" id="product">
            <div class="productm__view">
                <h1 class="h3 options__name product__nameMob"><?php echo $heading_title; ?></h1>
            ...
            <div class="productm__options options">
                <h1 class="h3 options__name"><?php echo $heading_title; ?></h1>
                <div class="option__data data">
                    ...
                    <?php if ($price) { ?>
                        <ul class="list-unstyled">
                            <?php if (!$special) { ?>
                                <p class="data__newPrice"><?php echo $price; ?></p>
                            <?php } else { ?>
                                <p class="data__oldPrice"><?php echo $price; ?></p>
                                <p class="data__newPrice"><?php echo $special; ?></p>
                            <?php }
                            /*if ($tax) { ?>
          ...
          <?php } */ ?>
                ...
                if (1 || (!isset($is_ajax) || !$is_ajax)) { ?>
                    <button
                        type="button"
                        id="tinkoff-button-<?php echo $product_id; ?>"
                        style="margin-bottom: 8px;margin-right:8px;height: 48px;display:none;"
                        ...
                        tinkoff.create(
                            {
                                ...
                                promoCode: 'installment_0_0_3_4,5',
                                sum: sum
                            },
                            {
                                view: 'modal'
