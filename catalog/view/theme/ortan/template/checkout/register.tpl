<div class="row">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group authForm__input" style="display: <?php echo (count($customer_groups) > 1 ? 'block' : 'none'); ?>;">
        <label class="authForm__name control-label"><?php echo $entry_customer_group; ?></label>
      ...
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-firstname"><?php echo $entry_firstname; ?></label>
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-payment-firstname" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-lastname"><?php echo $entry_lastname; ?></label>
        <input type="text" name="lastname" value="" placeholder="<?php echo $entry_lastname; ?>" id="input-payment-lastname" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-email"><?php echo $entry_email; ?></label>
        <input type="text" name="email" value="" placeholder="<?php echo $entry_email; ?>" id="input-payment-email" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-telephone"><?php echo $entry_telephone; ?></label>
        <input type="text" name="telephone" value="" placeholder="<?php echo $entry_telephone; ?>" id="input-payment-telephone" class="form-control" />
      </div>
      <div class="form-group authForm__input">
        <label class="authForm__name control-label" for="input-payment-fax"><?php echo $entry_fax; ?></label>
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group authForm__input custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        <label class="authForm__name control-label" for="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
        <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control goodsin__select">
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group authForm__input custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        <label class="authForm__name control-label"><?php echo $custom_field['name']; ?></label>
    ...
    <fieldset>
      ...
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-password"><?php echo $entry_password; ?></label>
        <input type="password" name="password" value="" placeholder="<?php echo $entry_password; ?>" id="input-payment-password" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-confirm"><?php echo $entry_confirm; ?></label>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      ...
      <div class="form-group authForm__input">
        <label class="authForm__name control-label" for="input-payment-company"><?php echo $entry_company; ?></label>
        <input type="text" name="company" value="" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-address-1"><?php echo $entry_address_1; ?></label>
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-payment-address-1" class="form-control" />
      </div>
      <div class="form-group authForm__input">
        <label class="authForm__name control-label" for="input-payment-address-2"><?php echo $entry_address_2; ?></label>
        <input type="text" name="address_2" value="" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-city"><?php echo $entry_city; ?></label>
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-payment-city" class="form-control" />
      </div>
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-postcode"><?php echo $entry_postcode; ?></label>
      ...
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-country"><?php echo $entry_country; ?></label>
        <select name="country_id" id="input-payment-country" class="form-control goodsin__select">
          <option value=""><?php echo $text_select; ?></option>
      ...
      <div class="form-group authForm__input required">
        <label class="authForm__name control-label" for="input-payment-zone"><?php echo $entry_zone; ?></label>
        <select name="zone_id" id="input-payment-zone" class="form-control goodsin__select">
        </select>
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
...
<div class="buttons clearfix">
  <div class="pull-right"><?php echo $text_agree; ?> &nbsp;
    ...
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn_red" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
...
$('#account .form-group authForm__input[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#account .form-group authForm__input').length) {
		$('#account .form-group authForm__input').eq($(this).attr('data-sort')).before(this);
	}

	if ($(this).attr('data-sort') > $('#account .form-group authForm__input').length) {
		$('#account .form-group authForm__input:last').after(this);
	}
	...
	if ($(this).attr('data-sort') < -$('#account .form-group authForm__input').length) {
		$('#account .form-group authForm__input:first').before(this);
	}
});

$('#address .form-group authForm__input[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#address .form-group authForm__input').length) {
		$('#address .form-group authForm__input').eq($(this).attr('data-sort')).before(this);
	}

	if ($(this).attr('data-sort') > $('#address .form-group authForm__input').length) {
		$('#address .form-group authForm__input:last').after(this);
	}
	...
	if ($(this).attr('data-sort') < -$('#address .form-group authForm__input').length) {
		$('#address .form-group authForm__input:first').before(this);
	}
});
