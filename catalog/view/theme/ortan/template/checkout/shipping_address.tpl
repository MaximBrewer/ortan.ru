<form class="form-horizontal">
  ...
  <div id="shipping-existing">
    <select name="address_id" class="form-control goodsin__select">
  ...
  <div id="shipping-new" style="display: <?php echo ($addresses ? 'none' : 'block'); ?>;">
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-firstname"><?php echo $entry_firstname; ?></label>
      <div class="col-sm-10">
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>" id="input-shipping-firstname" class="form-control" />
      </div>
    </div>
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-lastname"><?php echo $entry_lastname; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group authForm__input">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-company"><?php echo $entry_company; ?></label>
      <div class="col-sm-10">
        <input type="text" name="company" value="" placeholder="<?php echo $entry_company; ?>" id="input-shipping-company" class="form-control" />
      </div>
    </div>
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-address-1"><?php echo $entry_address_1; ?></label>
      <div class="col-sm-10">
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>" id="input-shipping-address-1" class="form-control" />
      </div>
    </div>
    <div class="form-group authForm__input">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-address-2"><?php echo $entry_address_2; ?></label>
      <div class="col-sm-10">
        <input type="text" name="address_2" value="" placeholder="<?php echo $entry_address_2; ?>" id="input-shipping-address-2" class="form-control" />
      </div>
    </div>
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-city"><?php echo $entry_city; ?></label>
      <div class="col-sm-10">
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>" id="input-shipping-city" class="form-control" />
      </div>
    </div>
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-postcode"><?php echo $entry_postcode; ?></label>
      <div class="col-sm-10">
    ...
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-country"><?php echo $entry_country; ?></label>
      <div class="col-sm-10">
        <select name="country_id" id="input-shipping-country" class="form-control goodsin__select">
    ...
    <div class="form-group authForm__input required">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-zone"><?php echo $entry_zone; ?></label>
      <div class="col-sm-10">
        <select name="zone_id" id="input-shipping-zone" class="form-control goodsin__select">
        </select>
      </div>
    </div>
    ...
    <div class="form-group authForm__input<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
      <label class="authForm__name col-sm-2 control-label" for="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
      <div class="col-sm-10">
        <select name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control goodsin__select">
          <option value=""><?php echo $text_select; ?></option>
    ...
    <div class="form-group authForm__input<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
      <label class="authForm__name col-sm-2 control-label"><?php echo $custom_field['name']; ?></label>
      <div class="col-sm-10">
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-shipping-address" data-loading-text="<?php echo $text_loading; ?>" class="btn btn_red" />
    </div>
  </div>
</form>
...
//--></script>
<script type="text/javascript"><!--
$('#collapse-shipping-address .form-group authForm__input[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#collapse-shipping-address .form-group authForm__input').length-2) {
		$('#collapse-shipping-address .form-group authForm__input').eq(parseInt($(this).attr('data-sort'))+2).before(this);
	}

	if ($(this).attr('data-sort') > $('#collapse-shipping-address .form-group authForm__input').length-2) {
		$('#collapse-shipping-address .form-group authForm__input:last').after(this);
	}
	...
	if ($(this).attr('data-sort') < -$('#collapse-shipping-address .form-group authForm__input').length-2) {
		$('#collapse-shipping-address .form-group authForm__input:first').before(this);
	}
});
//--></script>
<script type="text/javascript"><!--
