...
<body style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; color: #000000;">
  <div style="width: 680px;"><a href="<?php echo $store_url; ?>" title="<?php echo $store_name; ?>"><img src="<?php echo $logo; ?>" alt="<?php echo $store_name; ?>" style="margin-bottom: 20px; border: none;" /></a>
    ...
    <div style="margin-top: 0px; margin-bottom: 20px;">
      <a style="height: 41px; line-height:41px;text-align:center;text-decoration:none; color: #f2f2f2;  border-radius: 2px;  font-weight: 700;  font-size: 14px;  border: none;  text-transform: uppercase;  cursor: pointer;  transition: all 0.2s ease-in-out;  min-width: 188px;background: #e6000a;border: 1px solid #e6000a;float:right;" href="https://ortan.ru/index.php?route=checkout/payfromemail&order_id=<?php echo $order_id; ?>">Оплатить</a>
      ...
      <tbody>
        <tr>
          <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
            ...
            <?php if ($shipping_method && $shipping_method != 'Бесплатная доставка') { ?>
