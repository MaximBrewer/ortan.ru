...
<div style="max-width: 640px;margin: 20px auto;background: #ffffff;">
    ...
    <div style="padding: 10px;">
        <p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_admin_title; ?></p>

        <p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_customer_info; ?></p>

        <p style="margin-top: 0px; margin-bottom: 20px;color: #777777"><?php echo $text; ?></p>

        <p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_product; ?></p>
        ...
        <?php if ($automoderate) { ?>
<p style="margin-top: 0px; margin: 20px 0;font-size: 15px;"><?php echo $text_review_automaderate; ?></p><?php } ?>

        <?php if (($text_bonus && $customer_id > 0)) { ?>
        <p style="margin-top: 0px; margin: 20px 0;font-size: 15px;"><?php echo $text_bonus; ?></p>
        <p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_admin_account; ?></p>
        <?php } ?>

        <a href="<?php echo $review_link; ?>" style="margin: 0 auto 30px;display: block;width: 150px;height: 40px;line-height: 40px;background: #17a944;text-align: center;border-radius: 4px;color: #fff;text-decoration: none;font-size: 16px;"><?php echo $text_more; ?></a>
    </div>
