...
<div style="max-width: 640px;margin: 20px auto;background: #ffffff;">
    ...
    <div style="padding: 10px;">
        <?php if ($text_hello) { ?>
<p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_hello; ?></p><?php } ?>

        <p style="margin-top: 0px; margin-bottom: 20px;font-size: 15px;"><?php echo $text_info; ?></p>
        ...
        <p style="margin-top: 0px; margin: 20px 0;font-size: 15px;"><?php echo $text_customer_info; ?></p>
        <p style="margin-top: 0px; margin-bottom: 20px;color: #777777"><?php echo $text; ?></p>
        <?php if ($link) { ?>
        <a href=" <?php echo $link; ?>" style="margin: 0 auto 30px;display: block;width: 150px;height: 40px;line-height: 40px;background: #17a944;text-align: center;border-radius: 4px;color: #fff;text-decoration: none;font-size: 16px;"><?php echo $text_more; ?></a><?php } ?>
    </div>
