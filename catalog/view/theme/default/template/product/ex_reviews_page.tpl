<?php echo $header; ?>
<?php if (isset($settings['all_noindex'])){ ?>
<meta name="robots" content="noindex, follow"/>
<?php }?>
<div class="container ex-reviews-page">
  <ul class="breadcrumb ex-breadcrumb">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h1 class="heading_title_reviews"><span><?php echo $heading_title; ?></span></h1>
      <?php } ?>
      <?php if ($reviews) { ?>
        ...
        <div class="ex-reviews-stack">
          <?php foreach($reviews as $_key => $review) { ?> 
            <div class="review-container">
              ...
              <div class="ex-image"><a href="<?php echo $review['prod_href']; ?>"><img src="<?php echo $review['prod_thumb']; ?>"
                    alt="<?php echo $review['prod_name']; ?>" title="<?php echo $review['prod_name']; ?>" class="img-responsive" /></a>
                <div class="ex-product-name"><a href="<?php echo $review['prod_href']; ?>"><?php echo $review['prod_name']; ?></a></div>
              </div>
              <div class="ex-caption">
                  ...
                  <div class="review-rating-change-buttons">
                    <button class="review-vote review-vote-positive" data-value="<?php echo $review['review_id']; ?>">
                      ...
                      <span class="review-vote-count" data-value="<?php echo $review['likes']; ?>"
                        id="vote_count_positive-<?php echo $review['review_id']; ?>"><?php echo (($review['likes'] > 0) ? ($review['likes']) : ('0')); ?></span>
                    </button>
                    <button class="review-vote review-vote-negative" data-value="<?php echo $review['review_id']; ?>">
                      ...
                      <span class="review-vote-count" data-value="<?php echo $review['dislikes']; ?>"
                        id="vote_count_negative-<?php echo $review['review_id']; ?>"><?php echo (($review['dislikes'] > 0) ? ($review['dislikes']) : ('0')); ?></span>
                    </button>
                  </div>
                </div>
                ...
                <div class="review-media-container">
                  ...
                  <div class="ex-drag ex-photo-thumbnails">
                    ...
                    <div class="ex-image-additional"><a class="ex-thumbnail"
                        ...
                        title="<?php echo $review['prod_name']; ?>"> <img src="<?php echo $image['thumb']; ?>" title="<?php echo $review['prod_name']; ?>"
                  ...
                  <div class="ex-drag ex-video-thumbnails">
                    ...
                    <div class="ex-video-thumbnail"><a <?php echo (isset($settings['fancy']) ? ('data-fancybox') : ('')); ?>
                        class="popup-youtube" href="https://www.youtube.com/watch?v=<?php echo $video; ?>?autoplay=1&rel=0"><img
                ...
                <div class="review-container-footer">
                  ...
                  <button type="button" class="ex-btn ex-light review-answer-button"
                    data-value="<?php echo $review['review_id']; ?>" data-product="<?php echo $review['product_id']; ?>"><svg class="ex-reply-svg">
          ...
          <?php if (isset($more)) { ?>
            <div class="text-center show-more-block">
              <button class="show-more-button" id="show-more" onclick="showMore('<?php echo $more; ?>')"><svg class="ex-more-svg"><use xlink:href="#ex-more"></use></svg> <?php echo $more_text; ?></button>
            </div>
          <?php } ?>
...
<div class="ex-hidden" id="hidden-popups">
  <form class="form-horizontal" id="form-answer-review">
    ...
    <div class="ex-form-buttons">
      ...
      <button type="button" class="opbtn__buy btn" id="button-answer-review"
