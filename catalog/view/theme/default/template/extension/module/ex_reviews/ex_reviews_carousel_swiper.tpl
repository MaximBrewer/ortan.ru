	...
	<div class="ex-reviews__carousel" id="ex-reviews-carousel<?php echo $module; ?>">
		<div class="<?php echo $settings['box_classname']; ?>">
			...
			<div class="swiper-pagination ex-reviews__carousel-pagination<?php echo $module; ?>"></div>
			<?php } ?>
...
$('#ex-reviews-carousel<?php echo $module; ?> .ex-reviews__carousel-container').swiper({
	mode: 'horizontal',
	slidesPerView: <?php echo $carousel['count_1200']; ?>,
	pagination: '.ex-reviews__carousel-pagination<?php echo $module; ?>',
	paginationClickable: true,
	nextButton: '.ex-swiper-button-next',
	prevButton: '.ex-swiper-button-prev',
	spaceBetween: <?php echo (($style['box']['margin']) ? ($style['box']['margin']) : (10)); ?>,
	autoplayDisableOnInteraction: true,
	loop: true,
	breakpoints: {
	    1200: {
      slidesPerView: <?php echo $carousel['count_769']; ?>,
    },
    769: {
      slidesPerView: <?php echo $carousel['count_481']; ?>,
    },
	    480: {
      slidesPerView: <?php echo $carousel['count_0']; ?>,
    }
  }
});
