...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['base'] = $server . (defined('CITY_CODE') && CITY_CODE != 'msk' ? CITY_CODE . '/' : '');
		...
		$data['telephone'] = isset($cityArray['phone']) && $cityArray['phone'] ? $cityArray['phone'] : $this->config->get('config_telephone');
		...
		$data['cities'] = $this->load->controller('extension/module/citychooser');
		$data['search'] = $this->load->controller('common/search');
		$data['cart'] = $this->load->controller('common/cart');
		$data['wishlist'] = isset($this->session->data['wishlist']) ? $this->session->data['wishlist'] : [];
		$data['compare'] = isset($this->session->data['compare']) ? $this->session->data['compare'] : [];
