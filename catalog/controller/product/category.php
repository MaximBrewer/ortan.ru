...
*/
			...
			if ($product_total <= ($page - 1) * $limit) {


				$this->response->redirect($this->url->link('product/category', 'path=' . $this->request->get['path'] . $url . '&page=' . ceil($product_total / $limit)));
			...
			$data['description'] = !isset($this->request->get['page']) || $this->request->get['page'] == 1 ? $data['description']  : '';
