...
class ControllerProductProduct extends Controller
{
	...
	public function index()
	{
		...
		if ($product_info) {
			...
			$data['text_size_hint'] = $this->language->get('text_size_hint');
			...
			$city = $this->model_extension_module_citychooser_city->getCity(CITY_CODE);
			$this->document->setTitle(str_replace(["{H1}", "{городе}"], [$product_info['meta_h1'] ? $product_info['meta_h1'] : $product_info['name'], $city['address_city2']], $product_info['meta_title']));
			$this->document->setDescription(str_replace(["{H1}", "{городе}"], [$product_info['meta_h1'] ? $product_info['meta_h1'] : $product_info['name'], $city['address_city2']], $product_info['meta_description']));
	...
	public function autocomplete()
	{
		...
		if (isset($this->request->get['filter_name']) || isset($this->request->get['filter_model'])) {
			...
			$results = $this->model_catalog_product->autocomplete($this->request->get['filter_name'], $this->session->data['customer_id']);
