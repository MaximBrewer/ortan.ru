...
class ControllerSettingSetting extends Controller {
    ...
    if ($this->config->get('config_editor_default')) {
      ...
      $this->request->post['config_contacts_text'] = $this->request->post['config_langdata'][$front_language_id]['contacts_text'];

      $this->request->post['config_delivery_text'] = $this->request->post['config_langdata'][$front_language_id]['delivery_text'];
		...
		if (isset($this->request->post['config_delivery_text'])) {
			$data['config_delivery_text'] = $this->request->post['config_delivery_text'];
		} else {
			$data['config_delivery_text'] = $this->config->get('config_delivery_text');
		}
		...
		if (isset($this->request->post['config_social_telegram'])) {
			$data['config_social_telegram'] = $this->request->post['config_social_telegram'];
		} else {
			$data['config_social_telegram'] = $this->config->get('config_social_telegram');
		}
