...
class ControllerExtensionModuleCdekIntegrator extends Controller {
	...
	public function index() {
		...
		$rdata['text_updatecity'] = $this->language->get('text_updatecity');
		...
		foreach ($results as $dispatch_info) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('extension/module/cdek_integrator/dispatchView', 'token=' . $this->session->data['token'] . '&order_id=' . $dispatch_info['order_id'], 'SSL')
			);
			...
			$rdata['dispatches'][] = array(
				...
				'sync'					=> $this->url->link('extension/module/cdek_integrator/dispatchSync', 'token=' . $this->session->data['token'] . '&target=list&order_id=' . $dispatch_info['order_id'], 'SSL'),
				'action'				=> $action
			);

		}

		$rdata['dispatch_list'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'], 'SSL');

		$rdata['order'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'], 'SSL');
		$rdata['option'] = $this->url->link('extension/module/cdek_integrator/option', 'token=' . $this->session->data['token'], 'SSL');
		$rdata['update_city'] = $this->url->link('extension/module/cdek_integrator/updateCities', 'token=' . $this->session->data['token'], true);
		$rdata['cancel'] = $this->url->link('extension/extension', 'token=' . $this->session->data['token'] . '&type=module', true);
	...
	private function orderList() {
		...
		if ($this->new_application) {
			$this->response->redirect($this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if (isset($this->request->get['limit'])) {
  		...
  		$rdata['breadcrumbs'] = array();
   		...
   		$rdata['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL'),
   		);

		$rdata['create'] = html_entity_decode($this->url->link('extension/module/cdek_integrator/createOrder', 'token=' . $this->session->data['token'], 'SSL'), ENT_QUOTES, 'UTF-8');
		$rdata['cancel'] = $this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL');
    	...
    	foreach ($results as $result) {
			...
			$action[] = array(
				...
				'href' => $this->url->link('extension/module/cdek_integrator/createOrder', 'token=' . $this->session->data['token'] . '&orders[]=' . $result['order_id'] . $url, 'SSL')
			);
		...
		$rdata['sort_order'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$rdata['sort_customer'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, 'SSL');
		$rdata['sort_status'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$rdata['sort_total'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&sort=o.total' . $url, 'SSL');
		$rdata['sort_date_added'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&sort=o.date_added' . $url, 'SSL');
		...
		foreach ($this->limits as $item) {
			$rdata['limits'][$item] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . '&limit=' . $item . $url, 'SSL');
		}
		...
		$pagination->url = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	public function createOrder() {
		...
		if (empty($this->request->get['orders']) || !array_filter($this->request->get['orders'])) {
			$this->response->redirect($this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateOrderFrom()) {
			...
			if ($this->config->get('shipping_cdek_log')) {
				$this->log->write('СДЭК: xml');
				$this->log->write(print_r($component->xml, 1));
			}			
			...
			if (count($cdek_orders)) {
				...
				if ($all) {
					...
					$this->response->redirect($this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . $url, 'SSL'));
				}
		...
		$rdata['text_yes'] = $this->language->get('text_yes');
		$rdata['text_no'] = $this->language->get('text_no');
		$rdata['text_package'] = $this->language->get('text_package');
		...
		$rdata['breadcrumbs'] = array();
   		...
   		$rdata['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'] . $url, 'SSL'),
   		);
		...
		$rdata['action'] = $this->url->link('extension/module/cdek_integrator/createOrder', 'token=' . $this->session->data['token'] . $url, 'SSL');
		$rdata['update_city'] = $this->url->link('extension/module/cdek_integrator/updateCities', 'token=' . $this->session->data['token'], true);
		$rdata['cancel'] = $this->url->link('extension/module/cdek_integrator/order', 'token=' . $this->session->data['token'], 'SSL');
		...
		$rdata['pass'] = md5(date('Y-m-d', time() + 10800) . '&' . $this->setting['secure_password']);
	...
	public function option() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateOption()) {
			...
			if (isset($this->request->get['redirect'])) {
				$redirect = $this->url->link('extension/module/cdek_integrator/option', 'token=' . $this->session->data['token'], 'SSL');
			} else {
				$redirect = $this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL');
			}
		...
		$rdata['action'] = $this->url->link('extension/module/cdek_integrator/option', 'token=' . $this->session->data['token'], 'SSL');
		$rdata['cancel'] = $this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL');
		...
		$rdata['token'] = $this->request->get['token'];
	...
	private function dispatchList() {
		...
		$rdata['breadcrumbs'] = array();
   		...
   		$rdata['breadcrumbs'][] = array(
       		'text'      => $this->language->get('heading_title_bk_main'),
			'href'      => $this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'] . $url, 'SSL'),
   		);
		...
		foreach ($results as $dispatch_info) {
			...
			$action[] = array(
				'text' => $this->language->get('text_view'),
				'href' => $this->url->link('extension/module/cdek_integrator/dispatchView', 'token=' . $this->session->data['token'] . '&order_id=' . $dispatch_info['order_id'] . $url, 'SSL')
			);

			$action[] = array(
				'text'	=> $this->language->get('text_sync'),
				'href'	=> $this->url->link('extension/module/cdek_integrator/dispatchSync', 'token=' . $this->session->data['token'] . '&target=list&order_id=' . $dispatch_info['order_id'] . $url, 'SSL'),
				'class'	=> 'js sync'
			);
			...
			if ($dispatch_info['status_id'] == 1) {
				...
				$action[] = array(
					...
					'href' => $this->url->link('extension/module/cdek_integrator/dispatchDelete', 'token=' . $this->session->data['token'] . '&order_id=' . $dispatch_info['order_id'] . $url, 'SSL'),
					'class'	=> 'delete'
				);
		...
		$rdata['sort_order_id'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.order_id' . $url, 'SSL');
		$rdata['sort_dispatch_number'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=d.dispatch_number' . $url, 'SSL');
		$rdata['sort_act_number'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.act_number' . $url, 'SSL');
		$rdata['sort_date'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=d.date' . $url, 'SSL');
		$rdata['sort_city_from'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.city_name' . $url, 'SSL');
		$rdata['sort_city_to'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.recipient_city_name' . $url, 'SSL');
		$rdata['sort_status'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.status_id' . $url, 'SSL');
		$rdata['sort_total'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&sort=o.delivery_cost' . $url, 'SSL');
		...
		foreach ($this->limits as $item) {
			$rdata['limits'][$item] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . '&limit=' . $item . $url, 'SSL');
		}
		...
		$pagination->limit = $limit;
		$pagination->text = $this->language->get('text_pagination');
		$pagination->url = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	public function dispatchView() {
		...
		if ($this->new_application) {
			...
			$this->response->redirect($this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'], 'SSL'));
		}
		...
		if ($dispatch_info) {
			...
			$rdata['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'] . $url, 'SSL'),
			);
			...
			$rdata['sync'] = $this->url->link('extension/module/cdek_integrator/dispatchSync', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], 'SSL');
			$rdata['print'] = $this->url->link('extension/module/cdek_integrator/dispatchPrint', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], 'SSL');
			$rdata['cancel'] = $this->url->link('extension/module/cdek_integrator/dispatch', 'token=' . $this->session->data['token'], 'SSL');
			...
			if (file_exists(DIR_DOWNLOAD . 'cdek/order-' . $this->request->get['order_id'] . '.pdf') && is_file(DIR_DOWNLOAD . 'cdek/order-' . $this->request->get['order_id'] . '.pdf')) {
				$rdata['pdf'] = $this->url->link('extension/module/cdek_integrator/showPdf', 'token=' . $this->session->data['token'].'&order_id='.$this->request->get['order_id'], 'SSL');
			}
	...
	private function renderPage($render = TRUE) {
		...
		if ($render) {
			...
			$this->template = 'extension/module/cdek_integrator/page.tpl';
		}
	...
	public function dispatchPrint()
	{
		...
		if (file_exists(DIR_DOWNLOAD . 'cdek/order-' . $this->request->get['order_id'] . '.pdf'))
		{
			if ($this->isAjax())
			{
				...
				$json['file'] = $this->url->link('extension/module/cdek_integrator/showPdf', 'token=' . $this->session->data['token'].'&order_id='.$this->request->get['order_id'], 'SSL');
				$this->response->setOutput(json_encode($json));
				exit;
			} else {
				$this->response->redirect($this->url->link('extension/module/cdek_integrator/dispatchView', 'token=' . $this->session->data['token'] . '&order_id=' . $this->request->get['order_id'], 'SSL'));
			}
		}
	...
	public function dispatchDelete() {
		...
		if ($dispatch_info && $dispatch_info['status_id'] == 1) { // Удалить можно только новый заказ
			...
			if ($forced || empty($this->api->error)) {
				...
				$forced_delete = $this->url->link('extension/module/cdek_integrator/dispatchDelete', 'token=' . $this->session->data['token'] . '&order_id=' . $dispatch_info['order_id'] . '&forced', 'SSL');
	...
	public function dispatchSync() {
		...
		if ($dispatch_info) {
			...
			if (!empty($this->api->error)) {
				...
				//$this->model_extension_module_cdek_integrator->changeOrderStatusForce($dispatch_info['status_id'], $dispatch_info);
	...
	private function init() {
		...
		$secure_password = !empty($this->setting['secure_password']) ? $this->setting['secure_password'] : '';
		$this->api = new cdek_integrator($account, $secure_password);
	...
	public function updateCities() {
		...
		if (!empty($this->request->get['redirect'])) {
			$this->response->redirect($this->url->link($this->request->get['redirect'], 'token=' . $this->session->data['token'], 'SSL'));
		} else {
			$this->response->redirect($this->url->link('extension/module/cdek_integrator', 'token=' . $this->session->data['token'], 'SSL'));
		}	
	}
