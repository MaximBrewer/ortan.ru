...
class ControllerCatalogOCFilterPage extends Controller {
  ...
  public function add() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_catalog_ocfilter_page->addPage($this->request->post, isset($this->request->get['city_id']) ? $this->request->get['city_id'] : 510);
  ...
  public function edit() {
    ...
    if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
      $this->model_catalog_ocfilter_page->editPage($this->request->get['ocfilter_page_id'], $this->request->post, isset($this->request->get['city_id']) ? $this->request->get['city_id'] : 510);
  ...
  private function getForm() {
      ...
      $data['entry_image'] = $this->language->get('entry_image');
		...
		foreach($data['cities'] as &$city){
			$city['link'] = $this->url->link('catalog/ocfilter_page/edit', 'token='.$this->session->data['token'].'&ocfilter_page_id='.$this->request->get['ocfilter_page_id'].'&city_id='.$city['city_id'], true);
		}
    ...
    if (isset($this->request->get['ocfilter_page_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST')) {
      $page_info = $this->model_catalog_ocfilter_page->getPage($this->request->get['ocfilter_page_id'], isset($this->request->get['city_id']) ? $this->request->get['city_id'] : 510);
    }
    ...
    if (isset($this->request->post['params'])) {
      ...
      $data['params'] = '';
		...
		if (isset($this->request->post['page_description'])) {
			...
			$data['page_description'] = $this->model_catalog_ocfilter_page->getPageDescriptions($this->request->get['ocfilter_page_id'], isset($this->request->get['city_id']) ? $this->request->get['city_id'] : 510);
		} else {
    ...
    } elseif (!empty($page_info) && is_file(DIR_IMAGE . $page_info['image'])) {
      $data['thumb'] = $this->model_tool_image->resize($page_info['image'], 100, 100);
    } else {
