...
class ControllerToolExportImport extends Controller { 
	...
	protected function getForm() {
		...
		$data['entry_manufacturer_filter'] = $this->language->get( 'entry_manufacturer_filter' );
		...
		$data['help_manufacturer_filter'] = $this->language->get( 'help_manufacturer_filter' );
		...
		$data['text_welcome'] = str_replace('%1',$this->model_tool_export_import->getVersion(),$this->language->get('text_welcome'));
		...
		$data['version_export_import'] = $this->model_tool_export_import->getVersion();
