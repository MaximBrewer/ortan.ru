...
$_['text_updatesuccess']				= 'База городов обновлена!';
$_['text_updatecity']					= 'Обновить базу городов';
...
$_['text_package']                      = 'Отгружать каждый товар в отдельной упаковке';
$_['text_yes']					        = 'Да';
$_['text_no']					        = 'Нет';
...
$_['entry_new_order_status_id']			= '<span data-toggle="tooltip" title="В очередь на отгрузку попадут только заказы с выбранными статусами. Если не выбрано то в список попадут все заказы.">Статусы заказов для отгрузки</span>';
$_['entry_new_order']					= '<span data-toggle="tooltip" title="Количество дней, в течение которых заказ считается актуальным и попадет в список на отгрузку">Актуальность заказа</span>';
...
$_['text_testing_api_keys']				= 'Тестовые API ключи (после тестирования сменить на боевые): <br><b>Учетная запись:</b> %s <br> <b>Секретный код:</b> %s';
