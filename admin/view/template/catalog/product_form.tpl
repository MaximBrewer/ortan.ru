      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-yandexmarket" data-toggle="tab"><?php echo $tab_yandexmarket; ?></a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-store">Скалды доставки</label>
                <div class="col-sm-10">
                  <select name="store" id="input-store" class="form-control">
                    <option value="1" <?php if((int)$store === 1) echo 'selected="selected"';?>>Россия</option>
                    <option value="2" <?php if((int)$store === 2) echo 'selected="selected"';?>>Беларусь</option>
                    <option value="3" <?php if((int)$store === 3) echo 'selected="selected"';?>>Китай</option>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-yprice"><?php echo $entry_yprice; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="yprice" value="<?php echo $yprice; ?>" placeholder="<?php echo $entry_yprice; ?>" id="input-yprice" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-tax-class"><?php echo $entry_currency; ?></label>
                <div class="col-sm-10">
                  <select name="currency_id" id="input-tax-class" class="form-control">
            ...
            <div class="tab-pane" id="tab-yandexmarket">
              <div class="form-group">
                <label class="col-sm-2 control-label"><?php echo $entry_isyandexmarket; ?></label>
                <div class="col-sm-10">
                  <label class="radio-inline">
                    <?php if ($isyandexmarket) { ?>
                      <input type="radio" name="isyandexmarket" value="1" checked="checked" />
                      <?php echo $text_yes; ?>
                    <?php } else { ?>
                      <input type="radio" name="isyandexmarket" value="1" />
                      <?php echo $text_yes; ?>
                    <?php } ?>
                  </label>
                  <label class="radio-inline">
                    <?php if (!$isyandexmarket) { ?>
                    <input type="radio" name="isyandexmarket" value="0" checked="checked" />
                    <?php echo $text_no; ?>
                    <?php } else { ?>
                    <input type="radio" name="isyandexmarket" value="0" />
                    <?php echo $text_no; ?>
                    <?php } ?>
                  </label>
                </div>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-name-ym<?php echo $language['language_id']; ?>"><?php echo $entry_name_ym; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="product_description[<?php echo $language['language_id']; ?>][name_ym]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name_ym'] : ''; ?>" placeholder="<?php echo $entry_name_ym; ?>" id="input-name-ym<?php echo $language['language_id']; ?>" class="form-control" />
                  <?php if (isset($error_name_ym[$language['language_id']])) { ?>
                  <div class="text-danger"><?php echo $error_name_ym[$language['language_id']]; ?></div>
                  <?php } ?>
                </div>
              </div>
            </div>
