        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="content-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-delivery-text"><span>Текст для вкладки "доставка"</span></label>
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][delivery_text]" rows="5" placeholder='Текст для вкладки "доставка"' id="input-alert-delivery_text" class="form-control summernote"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['delivery_text'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-sizing-text"><span>Текст для вкладки "Как выбрать размер"</span></label>
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][sizing_text]" rows="5" placeholder='Текст для вкладки "Как выбрать размер"' id="input-alert-sizing_text" class="form-control summernote"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['sizing_text'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-contacts-text"><span>Текст для страницы "Контакты"</span></label>
                    <div class="col-sm-10">
                      <textarea name="config_langdata[<?php echo $language['language_id']; ?>][contacts_text]" rows="5" placeholder='Текст для страницы "Контакты"' id="input-alert-contacts_text" class="form-control summernote"><?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['contacts_text'] : ''; ?></textarea>
                    </div>
                  </div>
            ...
            <div class="tab-pane" id="tab-local">
              ...
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-social-telegram"><span>Telegram</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_social_telegram" value="<?php echo $config_social_telegram; ?>" placeholder="Telegram" id="input-admin-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-social-vk"><span>VK</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_social_vk" value="<?php echo $config_social_vk; ?>" placeholder="VK" id="input-admin-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-social-instagram"><span>Instagram</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_social_instagram" value="<?php echo $config_social_instagram; ?>" placeholder="Instagram" id="input-admin-limit" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-social-youtube"><span>Youtube</span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_social_youtube" value="<?php echo $config_social_youtube; ?>" placeholder="Youtube" id="input-admin-limit" class="form-control" />
                </div>
              </div>
