              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="hidden" name="user_id" value="<?php print($user_id); ?>" id="user_id" />
                  </div>
                </div>
              </form>
            </fieldset>
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		...
		type: 'post',
		dataType: 'json',
		data: 'order_status_id=' + encodeURIComponent($('select[name=\'order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()) + '&user_id=' + encodeURIComponent($('#user_id').val()),
		beforeSend: function() {
