          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <select name="filter_order_status[]" id="input-order-status" class="form-control" multiple="multiple">
                  <option value="*"></option>
        ...
        <form method="post" action="" enctype="multipart/form-data" id="form-order">
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked); $('#button-shipping, #button-invoice').prop('disabled', !this.checked);" /></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['customer']; ?><br/><a href="mailto:<?php echo $order['email']; ?>"><?php echo $order['email']; ?></a><br/><a href="tel:<?php echo $order['telephone']; ?>"><?php echo $order['telephone']; ?></a></td>
                  <td class="text-left"><?php echo $order['order_status']; ?></td>
                  <td class="text-right"><?php echo $order['total']; ?></td>
                  <td class="text-left"><?php echo $order['date_added']; ?></td>
                  <td class="text-left"><?php echo $order['date_modified']; ?></td>
                  <td class="text-left"><?php echo $order['shipping_method']; ?><br/>
                  <?php echo $order['shipping_city']; ?><br/>
                  <?php echo $order['shipping_address_1']; ?></td>
                  <td class="text-left">
                    <?php if ($order['comment']) { ?>
                      <?=$entry_client_comment;?><br/>
                      <?=$order['comment'];?>
                      <hr/>
                    <?php } ?>
                    <?php 
                    foreach($order['histories'] as $history):?>
                      <?=$history['date_added'];?>, <?=$history['user_name'];?><br/>
                      <?=$history['status'];?><br/>
                      <!-- <?=$history['notify'];?><br/> -->
                      <?=$history['comment'];?>
                      <hr/>
...
$('#button-filter').on('click', function() {
	...
	var filter_order_status = $('#input-order-status').val();
