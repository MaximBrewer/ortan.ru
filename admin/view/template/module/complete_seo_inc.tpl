...
<?php } else if ($gkd_snippet == 'snippet_metas') { ?>
  <?php if (version_compare(VERSION, '2.2', '>=') || $_config->get('mlseo_enabled')) { ?>
    ...
    <?php if ($item_type == 'category') { ?>
        <btn class="btn btn-block btn-default btnSeoGen" onClick="seoPackageGen('all', '<?php echo $_language_id; ?>', '<?php echo $_city_id; ?>', '')"><i class="fa fa-bolt"></i> Generate all SEO values</btn>
    <?php } else { ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <div class="input-group">
    <?php if ($item_type == 'category') { ?>
          <input type="text" name="<?php echo $item_type; ?>_description[<?php echo $_language_id; ?>][<?php echo $_city_id; ?>][seo_keyword]" value="<?php echo isset(${$item_type.'_description'}[$_language_id][$_city_id]) ? ${$item_type.'_description'}[$_language_id][$_city_id]['seo_keyword'] : ''; ?>" placeholder="<?php echo $_language->get('entry_keyword'); ?>" id="input-seo-keyword<?php echo $_language_id; ?>-<?php echo $_city_id; ?>" class="form-control" />
          <span class="input-group-addon btn btn-primary" data-toggle="tooltip" title="Generate value" onClick="seoPackageGen('seo_keyword', '<?php echo $_language_id; ?>', '<?php echo $_city_id; ?>', '')"><i class="fa fa-bolt"></i></span>
    <?php } else { ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <div class="input-group">
    <?php if ($item_type == 'category') { ?>
          <input type="text" name="<?php echo $item_type; ?>_description[<?php echo $_language_id; ?>][<?php echo $_city_id; ?>][seo_h1]" value="<?php echo isset(${$item_type.'_description'}[$_language_id][$_city_id]) ? ${$item_type.'_description'}[$_language_id][$_city_id]['seo_h1'] : ''; ?>" placeholder="SEO H1" id="input-seo-h1<?php echo $_language_id; ?>-<?php echo $_city_id; ?>" class="form-control" />
          <span class="input-group-addon btn btn-primary" data-toggle="tooltip" title="Generate value" onClick="seoPackageGen('seo_h1', '<?php echo $_language_id; ?>', '<?php echo $_city_id; ?>', '')"><i class="fa fa-bolt"></i></span>
    <?php } else { ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <div class="input-group">
    <?php if ($item_type == 'category') { ?>
          <input type="text" name="<?php echo $item_type; ?>_description[<?php echo $_language_id; ?>][<?php echo $_city_id; ?>][seo_h2]" value="<?php echo isset(${$item_type.'_description'}[$_language_id][$_city_id]) ? ${$item_type.'_description'}[$_language_id][$_city_id]['seo_h2'] : ''; ?>" placeholder="SEO H2" id="input-seo-h2<?php echo $_language_id; ?>-<?php echo $_city_id; ?>" class="form-control" />
          <span class="input-group-addon btn btn-primary" data-toggle="tooltip" title="Generate value" onClick="seoPackageGen('seo_h2', '<?php echo $_language_id; ?>', '<?php echo $_city_id; ?>', '')"><i class="fa fa-bolt"></i></span>
    <?php } else { ?>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <div class="input-group">
    <?php if ($item_type == 'category') { ?>
          <input type="text" name="<?php echo $item_type; ?>_description[<?php echo $_language_id; ?>][<?php echo $_city_id; ?>][seo_h3]" value="<?php echo isset(${$item_type.'_description'}[$_language_id][$_city_id]) ? ${$item_type.'_description'}[$_language_id][$_city_id]['seo_h3'] : ''; ?>" placeholder="SEO H3" id="input-seo-h3<?php echo $_language_id; ?>-<?php echo $_city_id; ?>" class="form-control" />
          <span class="input-group-addon btn btn-primary" data-toggle="tooltip" title="Generate value" onClick="seoPackageGen('seo_h3', '<?php echo $_language_id; ?>', '<?php echo $_city_id; ?>', '')"><i class="fa fa-bolt"></i></span>
    <?php } else { ?>
    ...
    <?php if ($item_type == 'category') { ?>
      ...
      function seoPackageGen(field, lang, city, store) {
        $.ajax({
          url: 'index.php?route=module/complete_seo/get_value&type=<?php echo $item_type; ?>&id=<?php echo isset($_GET[$item_type.'_id']) ? $_GET[$item_type.'_id'] : 0; ?>&field='+field+'&store='+store+'&lang='+lang+'&city='+city+'&<?php echo $token_type; ?>=<?php echo $token; ?>',
          method: 'POST',
          data: $('form#form-<?php echo $item_type; ?>').serialize(),
          dataType: 'json',
          success: function(values) {
