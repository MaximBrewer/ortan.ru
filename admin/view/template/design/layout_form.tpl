...
$('#module-column-left, #module-column-right, #module-content-top, #module-header-bottom, #module-content-bottom').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-header-bottom, #module-content-bottom').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>