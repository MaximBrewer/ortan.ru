              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <td class="text-right">Темная картинка</td>
                    <td></td>
                  </tr>
                </thead>
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    ...
                    <td class="text-right" style="width: 5%;">
                      <div class="checkbox">
                        <label>
                          <?php if ($banner_image['dark']) { ?>
                          <input type="checkbox" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][dark]" value="1" checked="checked" />
                          <?php } else { ?>
                          <input type="checkbox" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][dark]" value="1" />
                          <?php } ?>
                        </label>
                      </div>
                    </td>
