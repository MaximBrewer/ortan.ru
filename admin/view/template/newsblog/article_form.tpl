        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-article" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="article_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control this-input-for-translit" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="article_description[<?php echo $language['language_id']; ?>][description2]" placeholder="<?php echo $entry_description2; ?>" id="input-description2<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['description2'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-list<?php echo $language['language_id']; ?>"><?php echo $entry_list; ?></label>
                    <div class="col-sm-10">
                      <textarea name="article_description[<?php echo $language['language_id']; ?>][list]" placeholder="<?php echo $entry_list; ?>" id="input-list<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['list'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
            ...
            <div class="tab-pane" id="tab-data">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-author-image">Фото автора</label>
                <div class="col-sm-10">
                  <a href="" id="author_thumb-image" data-toggle="image" class="img-thumbnail"><img src="<?php echo $author_thumb; ?>" alt="" title="" data-placeholder="<?php echo $author_placeholder; ?>" /></a>
                  <input type="hidden" name="author_image" value="<?php echo $author_image; ?>" id="input-author-image" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-author">Имя автора</span></label>
                <div class="col-sm-10">
                  <input type="text" name="author" value="<?php echo $author; ?>" placeholder="Имя автора" id="input-author" class="form-control" />
                </div>
              </div>
              <div class="form-group">
...
$('input[name=\'related_products\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=newsblog/article/autocomplete_products&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
			success: function(json) {
				response($.map(json, function(item) {
					return {
