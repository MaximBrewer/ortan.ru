							...
							<ul id="tabs-order-<?php echo $order_info['order_id']; ?>" class="nav nav-tabs">
		          			...
		          			<div class="tab-content">
					              	...
					              	<div class="form-group">
					              		...
					              		<div class="col-sm-10">
					              			<select class="form-control" id="cdek-orders-<?php echo $order_info['order_id']; ?>-delivery-recipient-vat-rate" name="cdek_orders[<?php echo $order_info['order_id']; ?>][delivery_recipient_vat_rate]">
					              				<?php foreach ($vat_rate_list as $vat_rate => $vat_rate_info) { ?>
					              					<?php
					              						$selected = '';
					              					...
					              					?>
					              					<option value="<?php echo $vat_rate;?>" data-value="<?php echo $vat_rate_info['value'];?>" <?php echo $selected;?>><?php echo $vat_rate_info['text'];?></option>
					              				<?php } ?>
					              			</select>
								...
								<div id="order-<?php echo $order_info['order_id']; ?>-package" class="form-horizontal tab-pane">
                                    ...
                                    <div id="order-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>" class="package">
										<div class="form-horizontal">
											<div class="form-group required">
												...
												<div class="col-sm-10">
													<select class="form-control" id="cdek-orders-<?php echo $order_info['order_id']; ?>-currency" name="cdek_orders[<?php echo $order_info['order_id']; ?>][currency]">
														<?php foreach ($currency_list as $key => $value) { ?>
															<option <?php if (isset($order_info['currency']) and $order_info['currency'] == $key) { ?><?php echo 'selected="selected"'; ?><?php } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
											...
											<div class="form-group required">
												...
												<div class="col-sm-10">
													<input class="form-control" id="cdek-orders-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>-brcode" type="text" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][brcode]" value="<?php if (!empty($package_info['brcode'])) { ?><?php echo $package_info['brcode']; ?><?php } ?>" maxlength="20" />
												</div>
											</div>
											<div class="form-group required">
												...
												<div class="col-sm-10">
													<select id="cdek-orders-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>-pack" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][pack]" class="toggle form-control" data-toggletarget="#cdek-orders-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>-size-a-block">
                                                        <?php foreach ($boolean_variables as $key => $value) { ?>
															<option <?php if (isset($package_info['pack']) and $package_info['pack'] == $key) { ?><?php echo 'selected="selected"'; ?><?php } ?> value="<?php echo $key; ?>"><?php echo $value; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
											<div class="form-group required" id="cdek-orders-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>-size-a-block" style="<?php if (!isset($package_info['pack']) or !$package_info['pack']) { ?> <?php echo "display:none;"; ?><?php } ?>">
												...
												<div class="col-sm-10">
													<div class="form-inline">
														<input class="form-control" id="cdek-orders-<?php echo $order_info['order_id']; ?>-package-<?php echo $package_id; ?>-size-a" type="text" placeholder="<?php echo $text_short_length; ?>" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][size_a]" value="<?php if (!empty($package_info['size_a'])) { ?><?php echo $package_info['size_a']; ?><?php } ?>" size="2" /> x
														<input class="form-control" type="text" placeholder="<?php echo $text_short_width; ?>" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][size_b]" value="<?php if (!empty($package_info['size_b'])) { ?><?php echo $package_info['size_b']; ?><?php } ?>" size="2" /> x
														<input class="form-control" type="text" placeholder="<?php echo $text_short_height; ?>" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][size_c]" value="<?php if (!empty($package_info['size_c'])) { ?>{{package_info['size_c']; ?><?php } ?>" size="2" />
													</div>
													...
													<tr>
														...
														<td class="right package-item-payment">
															<div class="input-group">
																...
																<input type="text" <?php if (!$order_info['cod']) { ?> readonly="readonly"<?php } ?> class="form-control" name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][item][<?php echo $row; ?>][payment]" data-value="<?php echo $item['payment']; ?>" value="<?php echo $order_info['cod'] ? item['payment'] : 0; ?>" size="3" />
															</div>
															...
															<div class="input-group">
																...
																<select class="form-control" <?php if  (!$order_info['cod']) { ?> readonly="readonly"<?php } ?> name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][item][<?php echo $row; ?>][payment_vat_rate]">
                                                                    <?php foreach ($vat_rate_list as $vat_rate => $vat_rate_name) { ?>
																		<?php $selected = '' ?>
																		<?php if  (isset($item['payment_vat_rate']) and $item['payment_vat_rate'] == vat_rate) { ?>
															...
															<div class="input-group">
																...
																<input type="text" class="form-control" <?php if  (!$order_info['cod']) { ?> <?php echo ' readonly="readonly" '; ?><?php } ?> name="cdek_orders[<?php echo $order_info['order_id']; ?>][package][<?php echo $package_id; ?>][item][<?php echo $row; ?>][payment_vat_sum]" data-value="<?php echo $item['payment_vat_sum']; ?>" value="<?php echo $order_info['cod'] ? item['payment_vat_sum'] : 0; ?>" size="3" />
															</div>
									...
									<?php foreach ($order_info['full_packages'] as $package_id => $package_info) { ?>
									<div id="order-<?php echo $order_info['order_id']; ?>-full_package-<?php echo $package_id; ?>" class="full_package" style="display: none;">
														...
														<div class="input-group">
															...
															<?php foreach ($vat_rate_list as $vat_rate => $vat_rate_info) { ?>
																<?php
								              					...
								              					?>
																<option data-value="<?php echo $vat_rate_info['value'];?>" value="<?php echo $vat_rate;?>" <?php echo $selected;?>><?php echo $vat_rate_info['text'];?></option>
															<?php } ?>
															</select>
														</div>
			...
			success: function(json) {
				if (json.List) {
					...
					for (var row in json.List) {
						html += '<option value="' + json.List[row].Code + '" data-name="' + json.List[row].Name + '" data-y="' + json.List[row].y + '" data-x="' + json.List[row].x + '" data-address="' + json.List[row].Address + '" data-worktime="' + json.List[row].WorkTime + '" data-phone="' + json.List[row].Phone + '">' + json.List[row].Address + json.List[row].Phone +  '</option>';
					}
...
function getShippingPrice(order_id) {
	...
	if (!error.length) {
		...
		$.ajax({
			url : '<?php echo $api_ajax_url; ?>calculator/calculate_price_by_jsonp.php',
			jsonp : 'callback',
			data : {
  ...
  $(document).ready(function() {
    ...
    $(this).autocomplete({
      source: function(request,response) {
        $.ajax({
          url: 'index.php?route=extension/module/cdek_integrator/getCityByName&token=<?php echo $token; ?>&q=' +  encodeURIComponent(request),
          dataType: "json",
          success: function(data) {
            if(data) {
