...
<div id="content">
	...
	<div class="container-fluid">
		...
		<div id="export_import_welcome" class="alert alert-info">
			...
			<button type="button" class="close" data-dismiss="alert">&times;</button>
			<?php echo $text_welcome; ?><br /><br /><?php echo $text_used_category_ids; ?> <?php echo $text_used_product_ids; ?>
		</div>
		<?php } ?>
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab-export">
						<form action="<?php echo $export; ?>" method="post" enctype="multipart/form-data" id="export" class="form-horizontal">
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12"><?php echo $entry_export; ?></div>
							</div>
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12"><?php echo $entry_export_type; ?>
								</div>
								<div class="col-sm-12">
							...
							<div class="form-group" style="margin:0px;" id="export_filter">
								<div class="col-sm-6">
									<?php echo $entry_category_filter; ?>
									<span class="help"><?php echo $help_category_filter; ?></span>
									<br />
								...
								<div class="col-sm-6">
									<?php echo $entry_manufacturer_filter; ?>
									<span class="help"><?php echo $help_manufacturer_filter; ?></span>
									<br />
							...
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12">
									<a onclick="downloadData();" class="btn btn-primary"><span><?php echo $button_export; ?></span></a>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="tab-pane" id="tab-import">
						<form action="<?php echo $import; ?>" method="post" enctype="multipart/form-data" id="import" class="form-horizontal">
							...
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12">
									<?php echo $entry_upload; ?><br /><br />
									<input type="file" name="upload" id="upload" />
								</div>
							</div>
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12">
									<a onclick="uploadData();" class="btn btn-primary"><span><?php echo $button_import; ?></span></a>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="tab-pane" id="tab-settings">
						<form action="<?php echo $settings; ?>" method="post" enctype="multipart/form-data" id="settings" class="form-horizontal">
							...
							<div class="form-group" style="margin:0px;">
								<div class="col-sm-12">
									<a onclick="updateSettings();" class="btn btn-primary"><span><?php echo $button_settings; ?></span></a>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="tab-pane" id="tab-support">
						...
						<table class="table table-bordered table-hover">
							<tbody>
								<tr>
									<td class="text-nowrap"><?php echo $entry_version; ?></td>
									<td><?php echo $version_export_import; ?></td>
								</tr>
								<tr>
									<td class="text-nowrap"><?php echo $entry_oc_version; ?></td>
									<td><?php echo $version_opencart; ?></td>
								</tr>
								<tr>
									<td class="text-nowrap" style="vertical-align:top;"><?php echo $entry_license; ?></td>
									<td class="text-wrap"><?php echo $text_license; ?></td>
								</tr>
							</tbody>
						</table>
					</div>
